...
using App.MoreJee.Infrastructure.EntityConfigurations;
using MediatR;
...
namespace App.MoreJee.Infrastructure
{
    public class MoreJeeAppContext : DbContext, IUnitOfWork
    {
        #region propeties
        private readonly IMediator _mediator;
        private IDbContextTransaction _currentTransaction;
        public const string DEFAULT_SCHEMA = "morejeeapp";
        public IDbContextTransaction GetCurrentTransaction => _currentTransaction;
        public bool HasActiveTransaction => _currentTransaction != null;
        #endregion

        #region ctor
        protected MoreJeeAppContext()
        {
        }

        public MoreJeeAppContext(DbContextOptions<MoreJeeAppContext> options, IMediator mediator)
            : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new MapEntityTypeConfiguration());
            modelBuilder.ApplyConfiguration(new MaterialEntityTypeConfiguration());
            modelBuilder.ApplyConfiguration(new StaticMeshEntityTypeConfiguration());
